...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        paragraphs: [
          "Five years from now, our students won't remember the lecture on hooks. They will remember the four people they sat next to every day for sixteen weeks, the people who become their cofounders, hiring managers, and best engineers.",
  ...
  },
  {
    ...
    content: [
      ...
      {
        heading: "Weeks 1 to 2: The web, demystified",
        paragraphs: [
      ...
      {
        heading: "Weeks 3 to 5: JavaScript that doesn't lie to you",
        paragraphs: [
      ...
      {
        heading: "Weeks 6 to 8: React fundamentals",
        paragraphs: [
      ...
      {
        heading: "Weeks 9 to 11: Real world tooling",
        paragraphs: [
      ...
      {
        heading: "Weeks 12 to 14: Capstone project",
        paragraphs: [
      ...
      {
        heading: "Weeks 15 to 16: Career sprint",
        paragraphs: [
