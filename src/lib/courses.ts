...
export const courses: Course[] = [
  {
    ...
    projects: ["E-commerce storefront", "Real-time chat UI", "Dashboard analytics", "Portfolio site"],
  ...
  },
  {
    ...
    curriculum: [
      { module: "Node & TypeScript", topics: ["Runtime", "Modules", "Tooling"] },
      { module: "Databases", topics: ["PostgreSQL", "Indexes", "Migrations", "ORMs"] },
      { module: "APIs", topics: ["REST", "GraphQL", "WebSockets"] },
    ...
    requirements: ["Basic JavaScript", "Laptop 8GB+", "Curiosity for systems"],
  ...
  },
  {
    ...
    curriculum: [
      ...
      { module: "Backend", topics: ["Node", "PostgreSQL", "APIs"] },
  ...
  },
  {
    ...
    curriculum: [
      { module: "Python & ML basics", topics: ["NumPy", "Pandas", "scikit-learn"] },
      { module: "LLMs", topics: ["Prompting", "Function calling", "Agents"] },
      { module: "RAG", topics: ["Embeddings", "Vector DBs"] },
      { module: "Production", topics: ["Evals", "Cost", "Latency"] },
    ],
    projects: ["Customer support agent", "Doc Q&A", "Multi-agent workflow"],
    requirements: ["Basic Python", "Laptop 16GB recommended"],
    career: ["AI Engineer", "ML Engineer", "Applied Scientist"],
