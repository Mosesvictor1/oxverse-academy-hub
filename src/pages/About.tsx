    ...
    <SiteLayout>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-20 pb-16 lg:pt-28">
          ...
          >
            We exist to build the next{" "}
            <span className="gradient-text">10,000 African engineers</span>.
          </motion.h1>
          <p className="mt-8 max-w-2xl text-lg text-ink-muted text-pretty">
            OxVerse Academy is a physical tech training institute founded in Lagos. We're not a
            course platform. We're a campus, a community, and a launchpad.
          </p>
        </div>
      </section>
      ...
      <section className="border-y border-border bg-muted/30">
        <div className="mx-auto max-w-7xl px-6 py-24 grid lg:grid-cols-3 gap-12">
          {[
            ...
            {
              eyebrow: "Our Vision",
              title: "A continent of builders, not borrowers.",
              body: "By 2030, we aim to graduate 10,000 engineers, designers, and creators who ship products used worldwide.",
            },
            {
              eyebrow: "Our Values",
              title: "Craft, candor, and community.",
              body: "We obsess over quality, speak honestly, and lift each other up. No shortcuts, no fluff, no ego.",
            },
          ].map((b, i) => (
            <motion.div
              key={i}
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="max-w-3xl mb-14">
          ...
          <h2 className="mt-6 font-display text-4xl md:text-5xl font-bold tracking-tighter">
            Meet the people behind OxVerse.
          </h2>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 ">
          {[
            { n: "Victor Moses", r: "Co-Founder", img: moses},
            { n: "Igwilo Victor", r: "Co-Founder"  },
          ].map((m, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 20 }}
              ...
              className="group"
            >
              <div className="aspect-[4/5] border border-border rounded-2xl bg-gradient-to-br from-purple-200 to-purple-700 mb-4 group-hover:scale-[1.02] transition-transform">
                <img
                  src={m.img}
      ...
      <section className="border-t border-border bg-ink text-background">
        <div className="mx-auto max-w-7xl px-6 py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <SectionEyebrow>
              <span className="text-background/80">Campus culture</span>
            </SectionEyebrow>
            <h2 className="mt-6 font-display text-4xl md:text-5xl font-bold tracking-tighter">
              A place where curiosity is contagious.
            </h2>
            <p className="mt-6 text-background/70 text-lg max-w-md text-pretty">
              Open hours from 8am to 5pm. Whiteboards on every wall. Demo days every month.
              Hackathons every quarter.
            </p>
            <Link
              to="/gallery"
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-background text-foreground px-6 py-3 font-semibold hover:bg-primary hover:text-primary-foreground transition"
            >
