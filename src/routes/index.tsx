...
import { ArrowRight, ArrowUpRight, Sparkles, Cpu, Users, Trophy, Zap, GraduationCap, MapPin, ChevronDown } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "OxVerse Academy — Learn Today. Build Tomorrow." },
      { name: "description", content: "Premium physical tech academy in Lagos. World-class training in engineering, design, AI, and more. Enroll now." },
      { property: "og:title", content: "OxVerse Academy — Learn Today. Build Tomorrow." },
      { property: "og:description", content: "Africa's premium physical tech academy. Cohort-based, hands-on, career-ready." },
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-24 pb-20 lg:pt-32 lg:pb-28">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            >
              Africa's premium physical tech academy. Hands-on, cohort-based training
              in engineering, design, and AI — taught by world-class instructors at our
              Lagos campus.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <div className="flex -space-x-2">
                {[0,1,2,3].map(i => (
                  <div key={i} className="size-8 rounded-full border-2 border-background bg-gradient-to-br from-purple-200 to-purple-500" />
                ))}
              </div>
              <p><span className="text-ink font-semibold">2,400+</span> students transformed</p>
            </motion.div>
          </div>
...
function WhyOxVerse() {
  const features = [
    { icon: Users, title: "Small cohorts", desc: "Max 25 students per class. Real attention, real mentorship." },
    { icon: Cpu, title: "Industry stack", desc: "Same tools and workflows used at top global tech companies." },
    { icon: Zap, title: "Project-based", desc: "Ship 4–6 portfolio-grade projects per course. No fluff." },
    { icon: GraduationCap, title: "Career support", desc: "Resume reviews, mock interviews, and direct hiring partners." },
    { icon: Sparkles, title: "Modern campus", desc: "High-spec workstations, fast internet, designed for focus." },
    { icon: MapPin, title: "Lagos-based", desc: "Physical classes in Lekki. In-person mentorship that compounds." },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5">
            <SectionEyebrow><span className="text-background/80">Campus Experience</span></SectionEyebrow>
            <h2 className="mt-6 font-display text-4xl md:text-6xl font-bold tracking-tighter text-balance">
              Built for deep work.
            </h2>
            <p className="mt-6 text-background/70 text-lg max-w-md text-pretty">
              4,000 sq ft of focused space in Lekki. Ergonomic workstations,
              gigabit fiber, quiet pods, and a community that pushes you forward.
            </p>
          ...
          <div className="lg:col-span-7">
            <div className="relative aspect-[16/11] rounded-3xl overflow-hidden">
              <img src={campusImg} alt="OxVerse campus" className="size-full object-cover" loading="lazy" width={1600} height={1100} />
            </div>
          </div>
        </div>
      </div>
...
function Projects() {
  const projects = [
    { title: "Wakanda Pay", student: "Tobi A.", course: "Full Stack", color: "from-purple-500 to-purple-700" },
    { title: "Lumen AI", student: "Amara N.", course: "AI", color: "from-purple-700 to-purple-900" },
    { title: "Drift Mobile", student: "Kola I.", course: "Mobile", color: "from-purple-200 to-purple-500" },
    { title: "Orbit DAO", student: "Zara M.", course: "Web3", color: "from-purple-600 to-purple-900" },
  ];
  return (
    <section className="mx-auto max-w-7xl px-6 py-24">
...
function Testimonials() {
  const t = [
    { quote: "OxVerse didn't just teach me to code — they taught me to think like an engineer. Six months in, I landed a remote role at a YC startup.", name: "Tobi Adelaja", role: "Frontend Engineer @ Plana" },
    { quote: "The instructors are working professionals who actually care. The mentorship in-person made all the difference for me.", name: "Amara Nwosu", role: "Product Designer @ Flutterwave" },
    { quote: "I came in knowing nothing about AI. I left with a portfolio that got me four offers. Worth every naira.", name: "Kola Ibrahim", role: "AI Engineer @ Cohere" },
  ];
  return (
    <section className="border-y border-border bg-muted/30">
      <div className="mx-auto max-w-7xl px-6 py-24">
    ...
    <section className="mx-auto max-w-7xl px-6 py-24">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div className="relative aspect-square rounded-3xl overflow-hidden order-last lg:order-first">
          <img src={studentsImg} alt="OxVerse students" className="size-full object-cover" loading="lazy" width={1600} height={1000} />
        </div>
        <div>
          <SectionEyebrow>Career outcomes</SectionEyebrow>
          <h2 className="mt-6 font-display text-4xl md:text-5xl font-bold tracking-tighter text-balance">
            Skill that pays. <br /><span className="gradient-text">For decades.</span>
          </h2>
          <p className="mt-6 text-ink-muted text-lg max-w-lg text-pretty">
            We partner with 18+ companies across Africa and globally for direct hiring,
            internships, and real-world capstone projects. 92% of graduates land roles
            within 6 months.
          </p>
          <div className="mt-10 grid grid-cols-2 gap-4">
            {["Software Engineer", "Product Designer", "Data Analyst", "Mobile Developer", "AI Engineer", "Growth Marketer"].map((r) => (
              <div key={r} className="rounded-xl border border-border px-4 py-3 text-sm font-medium">{r}</div>
            ))}
          </div>
        </div>
      </div>
...
function FAQ() {
  const faqs = [
    { q: "Is OxVerse a physical academy or online?", a: "Strictly physical. All classes are held at our Lekki, Lagos campus. We believe in-person mentorship compounds faster than any online program." },
    { q: "How much do courses cost?", a: "Tuition ranges from ₦280,000 to ₦750,000 depending on the course. We offer installment plans and a limited number of need-based scholarships per cohort." },
    { q: "What are the entry requirements?", a: "Most courses require no prior experience. You'll need a laptop (8GB RAM minimum), stable internet, and the ability to commit 12–18 hours per week." },
    { q: "Will I get a certificate?", a: "Yes — every graduate receives an OxVerse Certificate of Completion plus portfolio reviews and career support." },
    { q: "Can I work full-time and study?", a: "Yes — we offer weekend cohorts (Sat–Sun) designed for working professionals." },
    { q: "Do you guarantee a job?", a: "We don't guarantee jobs, but we have a 92% placement rate within 6 months and direct hiring partnerships with 18+ companies." },
  ];
  return (
